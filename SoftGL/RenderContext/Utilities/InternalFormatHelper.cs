...
namespace SoftGL
{
    ...
    static class InternalFormatHelper
    {
        ...
        public static int BitSize(this uint internalFormat)
        {
            ...
            {
                case GL.GL_RGBA: result = 4 * 4 * 8; break; // vec4(r, g, b, a)
                case GL.GL_BGRA: result = 4 * 4 * 8; break; // vec4(b, g, r, a)
                ...
                case GL.GL_STENCIL_INDEX: result = 8; break; // TODO: what should this be?
