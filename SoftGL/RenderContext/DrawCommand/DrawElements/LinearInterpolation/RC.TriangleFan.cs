...
namespace SoftGL
{
    partial class SoftGLRenderContext
    {
        ...
        private unsafe List<Fragment> LinearInterpolationTriangleFan(int count, DrawElementsType type, IntPtr indices, VertexArrayObject vao, ShaderProgram program, GLBuffer indexBuffer, PassBuffer[] passBuffers)
        {
